...
![img](/images/hive/1561705874041.png)	
...
- 数据仓库的规模及其复杂性离不开正确的元数据管理，包括增加或移除外部数据源，改变数据清洗方法，控制出错的查询以及安排备份等。
  ...
  ![img](/images/hive/1561705895292.png)	
...
![img](/images/hive/1561705918286.png)	
...
![img](/images/hive/1561705940248.png)	

### 2.4. Hive与传统数据库对比

hive用于海量数据的离线数据分析

![img](/images/hive/1561705959607.png)	
...
hive (default)> select count(1) from log_text;

Time taken: 21.54 seconds, Fetched: 1 row(s)

2）ORC

hive (default)> select count(1) from log_orc;

Time taken: 20.867 seconds, Fetched: 1 row(s)

3）Parquet

hive (default)> select count(1) from log_parquet;
